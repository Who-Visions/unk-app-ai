...
class Thread(BaseModel):
    ...
    # Context
    context_refs: List[str] = Field(default_factory=list, description="Repo URLs, Ticket IDs, Doc IDs")
    ...
    # Telemetry
    metrics: Dict[str, Any] = Field(default_factory=lambda: {"tool_calls": 0, "tokens": 0, "latency_ms": 0})
