...
class ArchitectStrategy(Strategy):
    name = "Architect"

    def decide(self, req: BettingRequest, *, config: Dict[str, Any]) -> BettingDecision:
        # TODO: implement using patterns learned from: Solana-Prediction-Market
        # Expected outputs:
        ...
        return BettingDecision(
            ...
            stake=0.0,
            confidence=0.0,
            metadata={"source_repo": "Solana-Prediction-Market", "todo": True},
        )
